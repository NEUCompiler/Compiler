...
public class Calculator {
    ...
    public static void main(String[] args) {
    	...
    	System.out.println("55+1*(3+5)/2");
    	System.out.println();
    	System.out.println("Arithmetic expressions of the four yuan output is as follows:");
        Calculator cal  = new Calculator();
        String s = "55+1*(3+5)/2";
        double result  = cal.calculate(s);
        System.out.println();
        System.out.println("55+1*(3+5)/2"+"="+result);
    }
   

    /**
     * 按照给定的表达式计算
     * @param expression 要计算的表达式例如:55+1*(3+5)/2
     * @return
     */
    ...
    private String calculate(String firstValue,String secondValue,char currentOp) {
        ...
        switch(currentOp) {
            ...
            case '/':
                ...
                System.out.println("(/,"+firstValue+","+secondValue+","+result+")");                break;
        }
        return result;
    }
}
